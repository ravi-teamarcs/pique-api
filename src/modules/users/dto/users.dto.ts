...
export class CreateUserDto {
  ...
  @ApiProperty({ description: 'Role of the user', example: 'venue', enum: ['venue', 'entertainer'] })
...
export class UpdateUserDto {
  ...
  @ApiProperty({ description: 'Role of the user', example: 'venue', enum: ['venue', 'entertainer'], required: false })
  @IsEnum(['venue', 'entertainer'])
  @IsOptional()
  role?: 'venue' | 'entertainer';
}
